...
export const Cell = ({
  ...
  const classes = classnames(
    'border-solid border-2 mx-0.5 transform-gpu font-bold rounded sm:rounded-md transition-[height] duration-300 ease-in-out select-none',
    {
      ...
      'border-cell-deep shadow-inner ':
        !status || (!value && status === 'null'), // empty cell
    ...
    <div className={classes} style={{ animationDelay, animationDuration }}>
      <div
        className={classnames(
          'flex h-full transform-gpu items-center justify-center pb-0.5 transition-shadow',
