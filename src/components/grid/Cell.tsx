...
export const Cell = ({
  ...
  const classes = classnames(
    'border-solid border-2 mx-0.5 font-bold rounded sm:rounded-md transition-[height] duration-300 ease-in-out select-none',
    {
    ...
    <div className={classes} style={{ animationDelay, animationDuration }}>
      <div
        className={classnames(
          'flex h-full items-center justify-center pb-0.5 transition-shadow',
